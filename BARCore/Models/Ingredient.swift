...
public struct Ingredient: Codable, Hashable, Sendable, Identifiable {
    ...
    enum CodingKeys: String, CodingKey { case id, name, amount, unit, batchable, batchBehaviour, bottleSize, notes, prepComponent }
    ...
    public var measurement: String { MeasurementFormatter.string(amount, unit: unit) }
